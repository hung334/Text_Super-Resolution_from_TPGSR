...
if __name__ == '__main__':
    ...
    parser.add_argument('--aug_prob', type=float, default=0.8, help='')
    parser.add_argument('--use_myself_aug', action='store_true', default=False)
    parser.add_argument('--use_paddleocr_val', action='store_true', default=False)
    parser.add_argument('--use_paddleocr', action='store_true', default=True)
    parser.add_argument('--myself_data', action='store_true', default=False)
    ...
    parser.add_argument('--val_batch_size', type=int, default=None, help='')
